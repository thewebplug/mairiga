    ...
    <>
            ...
            <div className="hero__title">
              <h1>
                <span>
                  {" "}
                  <span className="span">
                    <div className="pills pill__1">Poet</div>
                    <div className="pills pill__2">Podcaster</div>
                    Ai
                  </span>
                  sha
                  <span className="span">
                    <div className="pills pill__3">Speaker</div>
                    tu
                  </span>{" "}
                  <span className="span">
                    <div className="pills pill__4">Podcaster</div>
                    Ma
                  </span>
                  ir
                  <span className="span">
                    <div className="pills pill__5">Philantropist</div>
                    iga
                  </span>
                </span>
                <br />
                ...
                <br />
                <span>Analytical Work</span>
              </h1>
              <button className="hero__title__button">View something</button>
            </div>
          </section>
          ...
          <section className="charity">
            ...
            <div className="charity__grid">
              <div>
                ...
                <img src={Image1} className="charity__grid-small maxXL" />
                <img src={Image1} className="charity__grid-small max" />
              </div>
              <div>
                <img src={Image1} className="charity__grid-big maxXL" />
          ...
          <section className="about">
            ...
            <div className="about__bio">
              <p className="about__bio-text">
                AISHA MAIRIGA was born in Zuru local government of Kebbi State
                on the 13th of May, 2002. She attended Hawwa International
                School, Gusau and Alkali Mika'ilu International School in Talata
                Mafara from 2006-2013. She then proceeded to Federal Government
                Collage Anka and subsequently Prince International School in
                Talata Mafara and International Modern School in Guinea Conakry
                from 2013-2019. She has written several papers on social issues
                and delivered many lectures in the academic field and in
                conferences as a guest speaker. She has also written many
                articles published in some reputable books. She is the author of
                Make Your Dreams Come True, and Girls Child Education, among
                others. She is a hardworking and determined young lady that is
                concerned about her fellow youths and how to help them achieve
                their dreams. She is also focused on seeing a generation of
                youths growing to become better individuals and citizens. She is
                a students, poet, motivational speaker, philanthropist, a mental
                health advocate and the founder and CEO of Mairiga Aid
                Foundation. She has passion for anything that has to do with
                girl child, helping the needy and mental health. Aisha Mairiga
                started “Changing The Mindset with Aishatu Mairiga” where she
                talks about random topics and pressing issues that are
                disturbing Teenagers and youth at large, this program comes in
                episodes and each episode comes with different educating topics
                that bring solutions and comfort to the viewers. The main that
                made her start this program is because of her passion for mental
                health, the main aim of the program is to create a safe space
                for Youth especially Teenagers. To reassure them how capable,
                important and perfect in their own way they are. The program is
                set to encourage and motivate them to have a feeling of comfort,
                ...
                because mental health is definitely a priority. And mental
                health is health.
              </p>
            </div>
          </section>
      ...
      <section className="speaking">
        <div className="speaking__grid">
          <div className="speaking__grid-box">
            <img src={Image1} alt="" />
            <h3>Some event</h3>
          </div>
          <div className="speaking__grid-box">
      ...
      <section className="contact">
        <div className="form"  action="">
          <div className={contactActive === "name" ? "slide-in form__inner" : contactActive ? "slide-out" : "form__inner"}>
            {contactActive && <div className="form__inner__title">Hello there, What's your name?</div>}
            <input placeholder="Name" className="form__inner__input" type="text" />
            <button className="form__inner__button" type="none" onClick={() => setContactActive("email")}>Next</button>

          </div>
          <div className={contactActive === "email" ? "slide-in form__inner" : contactActive ? "slide-out" : "form__inner"} >
            {contactActive &&<div className="form__inner__title">Can i get your email 🙃?</div>}
            <input placeholder="Email" className="form__inner__input" type="text" />
            <button className="form__inner__button" type="none" onClick={() => setContactActive("type")}>Next</button>
          </div>
          <div className={contactActive === "type" ? "slide-in form__inner" : contactActive ? "slide-out" : "form__inner"}>
           {contactActive && <div className="form__inner__title">How may I be of help 😊?</div>}
            <select name="" id="" className="form__inner__input">
            <option value="d">Service type</option>
          </select>
          <button className="form__inner__button" type="none" onClick={() => setContactActive("message")}>Next</button>
          </div>
          <div className={contactActive === "message" ? "form__inner slide-in" : "form__inner"}>
            {contactActive  &&<div className="form__inner__title">Any other thing I should know 😊?</div>}
            <textarea
            name=""
          ...
          ></textarea>
           <button className="form__inner__button" type="none" onClick={() => setContactActive(false)}>Send</button>
          </div>
        ...
        <div className={contactActive ? "bar-top-curve slide-out" : "bar-top-curve"}>
        ...
        <div className={contactActive ? "contact__bar slide-out" : "contact__bar"}></div>
        <div className={contactActive ? "contact__box slide-out" : "contact__box"}>
          <div className="contact__box__title">
            <h2>
              Reach
              <br /> Aishatu <br /> Miariga.
            </h2>
          ...
          <div className="contact__box__sphere" onClick={() => setContactActive("name")}>
            <svg
              viewBox="0 0 300 300"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
